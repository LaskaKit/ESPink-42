...
GxEPD2_BW<GxEPD2_420_GDEY042T81, GxEPD2_420_GDEY042T81::HEIGHT> display(GxEPD2_420_GDEY042T81(/*CS=5*/ SS, /*DC=*/DC, /*RST=*/RST, /*BUSY=*/BUSY)); //GDEY042T81, 400x300, SSD1683 (no inking)
...
void WiFiInit() {
  ...
  while (WiFi.status() != WL_CONNECTED) {
    ...
    if (i == 10) {
      ...
      Serial.flush();
      // deep sleep mode
      gpio_hold_en((gpio_num_t)ePaperPowerPin);  // Hold Epaper on during sleep
...
void setup() {
  ...
  display.display(true);  // fast update
  delay(100);
